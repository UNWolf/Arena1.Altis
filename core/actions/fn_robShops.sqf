...
sleep (60 + random(180));
life_use_atm = true;
[[1,format["ARENA NEWS: Um posto de gasolina foi roubado em um total de $%1", [_kassa] call life_fnc_numberText]],"life_fnc_broadcast",civilian,false] spawn life_fnc_MP;
